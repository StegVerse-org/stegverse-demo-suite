...
class EvaluatorBoundaryTests(unittest.TestCase):
    def test_profile_is_identity_neutral_and_sdk_mediated(self) -> None:
        ...
        self.assertEqual(set(profile["sdk_mediated_routes"]), {"StegGhost/entity-sandbox-runner", "StegVerse-org/LLM-adapter:evaluator-entry"})
    ...
    def test_license_manifest_separates_license_from_service_relationship(self) -> None:
        ...
        self.assertEqual({c["repository"] for c in licenses["components"]}, {"StegVerse-org/stegverse-demo-suite", "StegVerse-org/StegVerse-SDK", "StegVerse-org/LLM-adapter"})
